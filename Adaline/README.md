...
Abaixo estão os gráficos gerados pela rede ADALINE durante a fase de treinamento:

**Evolução do Erro Quadrático Médio (T1 e T2):**
![Gráfico de EQM](grafico_eqm_t1_t2.png)

**Superfície 3D do Erro (T1):**
![Gráfico de Superfície 3D](grafico_superficie_3d_t1.png)

### Tabela de Previsão (Classificação das Amostras Teste)
Abaixo estão os resultados das previsões para as 15 amostras de teste da rede após os 5 treinamentos independentes. Como esperado (vide justificativa teórica), a rede obteve a mesma resposta em todos os treinamentos:

| Amostra | y (T1) | y (T2) | y (T3) | y (T4) | y (T5) |
|:-------:|:------:|:------:|:------:|:------:|:------:|
| 1       | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 2       | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 3       |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 4       | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 5       | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 6       |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 7       |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 8       |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 9       |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 10      | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 11      | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 12      |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
| 13      | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 14      | -1 (A) | -1 (A) | -1 (A) | -1 (A) | -1 (A) |
| 15      |  1 (B) |  1 (B) |  1 (B) |  1 (B) |  1 (B) |
